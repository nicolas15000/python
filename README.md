# SCRIPTS DE DATA SCIENCE EN FRANCAIS
...
-- Mastering Python for Finance by James Ma Weiming : Livre En anglais, super bien écrit, avec les scripts de la frontière efficiente, du Python Pulp, etc ..
